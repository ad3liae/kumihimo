...
/// they were mapped onto. Since Task 065 each is drawn as the one of the 30 it
/// is read as (`ThreadColorCatalog.formerIDs`); no colouring here has both
/// `white` and `natural`, which the 30 both read as 501.
