...
- **Task 022 台の上で組む（準静的）: 最高優先。Task 020 の続きである**: `tasks/022-braid-on-the-stand.md`
  ...
  - 段: 022-1'・022-2 完了、**022-2' で歯止め**（固定を深さで取る版。1サイクルは通るが (a) 不合格、重なり 0.15〜0.34 d。**糸が束の芯へ入り込む**）。**方式の見直し待ち**
...
- Task 022 台の上で組む（準静的）（**022-2' で歯止め。1サイクルは通るが (a) 不合格。糸が束の芯へ入り込んで重なる。方式の見直し待ち**）: `tasks/022-braid-on-the-stand.md`
