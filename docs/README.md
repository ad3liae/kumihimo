...
- Task 021 反発による深さの導出（**021d の反転0の確認で停止**。占有履歴（021b-1）で面の模様は出た。021d は**置いた交差の反転が 0 にならず、原因はトンネリングではなく置き方**——組み点が1手 0.25d しか進まないのに糸は 1d 太いので、置いた瞬間に食い込んでいる。**作者の判断待ち**）: `tasks/021-depth-by-relaxation.md`
