...
- Task 021 反発による深さの導出（実行済み・**不合格で停止**。長手の読み A のみ物理的に成立し pitch 0.375 は導出として立つが、緩和後の面は Task 004 とも p97 とも合わない。**Task 020 段階3 は着手しない**）: `tasks/021-depth-by-relaxation.md`
