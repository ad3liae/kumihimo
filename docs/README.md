...
- **Task 032 八つ金剛の立体を写真へ寄せる**（**段階0〜2 完了、段階3 未着手**。比較シートに載せ、
  差を数にした。**いちばん大きいのは谷の深さ（写真 0.025 対 立体 0.141、5.6倍）と、単位の格子の
  傾き（写真 +36° 対 立体 0°）**。傾きは**前提から直に出る**ので**判定待ち**。
  **前提が言っていて使っていないものが1つ見つかった——到着の位相**）:
