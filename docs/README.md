...
- Task 021 反発による深さの導出（**021c で停止**。占有履歴（021b-1）で面の模様は出た（丸源氏 Task 004 と 32/32）。長手を放して密に詰める 021c は、**ピッチが下向きの引きで決まってしまい踊り場が無い**（横向きの抑えが無く束が横へ広がる）。面は 29/32 まで来た。**作者の決定待ち**）: `tasks/021-depth-by-relaxation.md`
