...
- **Task 032 八つ金剛の立体を写真へ寄せる**（**判定 (1)(2)(3) まで反映。**描き手が鏡を描いていた
  （輪を台と逆回りに置いていた）ので直し、**同じ原因の「手前が透ける」も同時に直った。**刷られた1手を
  1瞬間として読み、到着の位相を入れた。描いたものを軸の周り 16 通りで測ると、**写真の歩幅と色の帯は
  それぞれ描いたものの範囲に入る。平源氏に内向きの三角形がある**（既知の問題として記録））:
