...
- **Task 022 台の上で組む（準静的）: 最高優先。Task 020 の続きである**: `tasks/022-braid-on-the-stand.md`
  ...
  - 段: 022-1'・022-2・022-2'・**022-2'' 完了**（拘束を硬くして **(a) が通った**。0.01 d 超の対は 0）。**(b) は交差の記録が 0 で未判定。成長の測り方の判断待ち**
...
- Task 022 台の上で組む（準静的）（**022-2'' まで。平源氏1サイクルで (a) が通った。(b) は未判定、成長の測り方は判断待ち**）: `tasks/022-braid-on-the-stand.md`
