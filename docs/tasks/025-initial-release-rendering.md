...
- 状態: **025-4 は折衷へ**（2026-09-09、作者の判定。**退役しない**）。**形は族の描き手、色は占有履歴。** 1〜3 完了、**4-1 の位相は bookC の時計へ移せず (i) に戻して止めている**（中心化の折り返しに当たる）。結果は末尾「025-4 の判定」「025-4 の 1〜2」「025-4 の 3」「025-4 の 4-1・4-2」
